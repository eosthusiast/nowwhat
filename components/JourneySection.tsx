...
const JourneySection: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center min-h-screen py-16 md:py-20">
      ...
      <motion.button
        ...
        className="group flex flex-col items-center gap-2 md:gap-2 text-white/60 hover:text-white transition-colors mt-8 md:mt-12 pb-8"
      >
