    ...
    <div className="flex flex-col items-center justify-center h-full text-white px-6 md:px-12">
      ...
      <div className="absolute bottom-24 md:bottom-12 w-full flex flex-col items-center gap-2 md:gap-6 px-6">
          ...
          <AnimatePresence>
            {showContinue && (
              <motion.button
                ...
                animate={{ opacity: 1, y: 0 }}
                onClick={onUnlock}
                className="group flex flex-col items-center gap-1 md:gap-2 hover:text-white/70 transition-colors"
              >
        ...
        <motion.p
          ...
          className="text-sm md:text-base tracking-[0.12em] md:tracking-[0.2em] uppercase font-sans text-center w-full"
        >
