...
export default function App() {
  ...
  const handleBegin = () => {
    if (audioEnded || isMuted) {
      const scrollTarget = typeof window !== 'undefined' ? window.innerHeight : 1000;
      ...
      <section className="min-h-screen flex flex-col items-center justify-center px-6 relative">
        ...
        >
          ...
          >
            ...
            >
              {audioEnded || isMuted ? 'Begin' : 'Listen...'}
            </button>
          </motion.div>
        </motion.div>
      </section>
      ...
      <section className="min-h-screen flex items-center justify-center px-6">
        ...
        >
          <motion.h1
            ...
            viewport={{ once: true }}
            className="text-6xl md:text-8xl lg:text-9xl font-light italic tracking-tight text-center"
          >
            now what?
          </motion.h1>
        </motion.div>
